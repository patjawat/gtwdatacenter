              ...
              <div className="card-body">
                <div className="media d-flex">
                  ...
                  <div className="media-body  text-right">
                    ...
                    <span>
                      <button type="button" class="btn btn-sm btn-outline-danger round">ครุภัณฑ์(รายการ)</button>
                      </span>
                  </div>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="media d-flex">
                  ...
                  <div className="media-body  text-right">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-danger round">สิ่งก่อสร้าง</button>
            ...
            <div className="card-body">
              <div className="media d-flex">
                ...
                <div className="media-body  text-right">
                  ...
                  <button type="button" class="btn btn-sm btn-outline-danger round">ทั้งหมด</button>
                </div>
              </div>
            </div>
          </div>
