            ...
            <div className="card-body">
              <div className="media d-flex">
                <div className="media-body text-left">
                  <h3 className="success">{status === "loading" ? <i className="la la-spinner spinner"></i> : data.person.total}</h3>
                  <h6>บุคคลากร</h6>
                </div>
                <div>
            ...
            <div className="card-body">
              <div className="media d-flex">
                <div className="media-body text-left">
                  ...
                  <h3 className="info">{status === "loading" ? <i className="la la-spinner spinner"></i> : data.assets.total}</h3>
